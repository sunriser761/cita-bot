...
def create_driver():
    ...
    # Знайти chromium
    chrome_bin = find_binary(["chromium", "chromium-browser", "google-chrome", "google-chrome-stable"])
    print("Chrome binary: " + str(chrome_bin))
    if chrome_bin:
        options.binary_location = chrome_bin

    # Знайти chromedriver
    chromedriver_bin = find_binary(["chromedriver"])
    print("Chromedriver: " + str(chromedriver_bin))
